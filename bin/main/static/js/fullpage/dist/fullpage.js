...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        var isLicenseValid = options && new RegExp('([\\d\\w]{8}-){3}[\\d\\w]{8}|03233C75-05F4478D-A7864A79-CCEB26A7').test(options.licenseKey) || document.domain.indexOf('alvarotrigo.com') > -1;
        ...
        */
        function addSlidesNavigation(section, numSlides){
            ...
            for(var i=0; i< numSlides; i++){
                appendTo(createElementFromHTML('<li><a href="javascript:void(0);"><span></span></a></li>'), $('ul', nav)[0] );
            }
